...
- ✅ Connected to project: `citypulseai-e2b65`
...
### **6. Data Flow ✅**
- ✅ data-ingestion → Firebase (`citypulse_events`)
...
```bash
✓ Firebase initialized - Project: citypulseai-e2b65
...
**Log File:** `/Users/kushagrakumar/Desktop/citypulseAI/ai-ml/server.log`
