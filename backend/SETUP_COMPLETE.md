...
- `firebase-credentials.json` - Firebase credentials validated (Project: citypulseai-e2b65)
...
bash -c "cd /Users/kushagrakumar/Desktop/citypulseAI/backend && /Users/kushagrakumar/Desktop/citypulseAI/backend/venv/bin/uvicorn app.main:app --reload --host 127.0.0.1 --port 8000"
```
...
### Status: ✅ Connected
- **Project ID:** citypulseai-e2b65
- **Database URL:** https://citypulseai-e2b65.firebaseio.com
- **Storage Bucket:** citypulseai-e2b65.appspot.com
...
```bash
cd /Users/kushagrakumar/Desktop/citypulseAI/data-processing
source venv/bin/activate
python main.py
```
...
2. Check Firebase project console: https://console.firebase.google.com/project/citypulseai-e2b65
