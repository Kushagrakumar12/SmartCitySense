...
2. Click **"Add project"**
3. Enter project name: `smartcitysense` (or your choice)
...
mv ~/Downloads/smartcitysense-*.json /Users/kushagrakumar/Desktop/SmartCitySense/data-ingestion/firebase-credentials.json
```
...
FIREBASE_PROJECT_ID=smartcitysense  # Your project ID
...
mv ~/Downloads/smartcitysense-*.json firebase-credentials.json
...
- **Firestore Project ID**: `smartcitysense`
