...
```bash
# Create the smartcitysense_events topic
kafka-topics --create \
  --topic smartcitysense_events \
...
```bash
# Should show 'smartcitysense_events'
...
# Describe a topic
kafka-topics --describe --topic smartcitysense_events --bootstrap-server localhost:9092

# Delete a topic
kafka-topics --delete --topic smartcitysense_events --bootstrap-server localhost:9092
```
...
- [ ] Topic `smartcitysense_events` created
