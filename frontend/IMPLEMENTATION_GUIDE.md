...
2. Click "Add Project"
3. Enter project name (e.g., "citypulse-ai")
...
3. Click Web icon (</>)
4. Register app with nickname "citypulse-frontend"
...
NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN=citypulse-ai.firebaseapp.com
NEXT_PUBLIC_FIREBASE_PROJECT_ID=citypulse-ai
NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET=citypulse-ai.appspot.com
...
# Run container
docker run -p 3000:3000 --env-file .env.local citypulse-frontend
```
