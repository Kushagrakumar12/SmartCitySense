...
1. Go to: https://console.firebase.google.com/project/citypulseai-e2b65/settings/general
...
```bash
cd /Users/kushagrakumar/Desktop/citypulseAI/frontend
npm run dev
...
1. Go to: https://console.firebase.google.com/project/citypulseai-e2b65
...
4. Select Web (</>) icon
5. Enter app nickname: "CityPulse Frontend"
...
const firebaseConfig = {
  apiKey: "AIza...",
  authDomain: "citypulseai-e2b65.firebaseapp.com",
  projectId: "citypulseai-e2b65",
  storageBucket: "citypulseai-e2b65.appspot.com",
...
NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN=citypulseai-e2b65.firebaseapp.com
NEXT_PUBLIC_FIREBASE_PROJECT_ID=citypulseai-e2b65
NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET=citypulseai-e2b65.appspot.com
